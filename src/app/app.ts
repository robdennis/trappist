...
export class App implements OnInit {
  ...
  readonly iconCategories: { [key: string]: { prefix: string; icons: string[], names?: string[] } } = {
    ...
    'Mana - Mana & Resource Symbols': {
      prefix: 'ms-',
      icons: ['ms-d', 'ms-e', 'ms-h', 'ms-l', 'ms-paw', 'ms-s', 'ms-infinity',]
    },
    'Mana - Card Symbols': {
      prefix: 'ms-',
      icons: [
  ...
  'Mana - DFC Icons': {
    ...
    'Mana - Groups': {
      ...
      icons: [
        ...
        'ms-school-prismari',
        'ms-school-quandrix',
        'ms-school-silverquill',
        'ms-school-witherbloom',
        'ms-school-brokers',
        'ms-school-cabaretti',
        'ms-school-maestros',
        'ms-school-obscura',
    ...
    'Mana - Arena Abilities': {
      prefix: 'ms-',
      icons: [
        'ms-ability-activated',
        'ms-ability-adamant',
        'ms-ability-adapt',
        'ms-ability-addendum',
        'ms-ability-adventure',
        'ms-ability-afflict',
        'ms-ability-afterlife',
        'ms-ability-aftermath',
        'ms-ability-alliance',
        'ms-ability-amass',
        'ms-ability-amass-orcs',
        'ms-ability-ascend',
        'ms-ability-backup',
        'ms-ability-bargain',
        'ms-ability-blitz',
        'ms-ability-boast',
        'ms-ability-case-solved',
        'ms-ability-case-solved-print',
        'ms-ability-casualty',
        'ms-ability-celebration',
        'ms-ability-changeling',
        'ms-ability-channel',
        'ms-ability-cleave',
        'ms-ability-cloak',
        'ms-ability-collect-evidence',
        'ms-ability-companion',
        'ms-ability-constellation',
        'ms-ability-convoke',
        'ms-ability-convoke-original',
        'ms-ability-corrupted',
        'ms-ability-coven',
        'ms-ability-craft',
        'ms-ability-crime',
        'ms-ability-d20',
        'ms-ability-day-night',
        'ms-ability-daybound-nightbound',
        'ms-ability-deathtouch',
        'ms-ability-decayed',
        'ms-ability-defender',
        'ms-ability-delve',
        'ms-ability-descend',
        ...
        'ms-ability-disturb',
        'ms-ability-domain',
        'ms-ability-double-strike',
        'ms-ability-dungeon',
        'ms-ability-eerie',
        'ms-ability-embalm',
        'ms-ability-enlist',
        'ms-ability-enrage',
        'ms-ability-enrage-original',
        'ms-ability-escape',
        'ms-ability-eternalize',
        'ms-ability-exalted',
        'ms-ability-expend',
        'ms-ability-exploit',
        'ms-ability-explore',
        'ms-ability-ferocious',
        'ms-ability-first-strike',
        'ms-ability-flash',
        'ms-ability-flying',
        'ms-ability-for-mirrodin',
        'ms-ability-forage',
        'ms-ability-foretell',
        'ms-ability-gift',
        'ms-ability-goad',
        'ms-ability-haktos-the-unscarred',
        'ms-ability-haste',
        'ms-ability-hexproof',
        'ms-ability-hexproof-black',
        'ms-ability-hexproof-blue',
        'ms-ability-hexproof-green',
        'ms-ability-hexproof-red',
        'ms-ability-hexproof-white',
        'ms-ability-hideaway',
        'ms-ability-impending',
        'ms-ability-improvise',
        'ms-ability-incubate',
        'ms-ability-indestructible',
        'ms-ability-investigate',
        'ms-ability-jumpstart',
        'ms-ability-kicker',
        'ms-ability-landfall',
        'ms-ability-learn',
        'ms-ability-lifelink',
        'ms-ability-lifelink-original',
        'ms-ability-magecraft',
        'ms-ability-manifest-dread',
        'ms-ability-meld',
        'ms-ability-menace',
        'ms-ability-mentor',
        'ms-ability-morph',
        ...
        'ms-ability-ninjutsu',
        'ms-ability-obscura',
        'ms-ability-offspring',
        'ms-ability-outlast',
        'ms-ability-party',
        'ms-ability-phyrexian',
        'ms-ability-plot',
        'ms-ability-proliferate',
        'ms-ability-prototype',
        'ms-ability-prowess',
        'ms-ability-raid',
        'ms-ability-reach',
        'ms-ability-read-ahead',
        'ms-ability-reconfigure',
        'ms-ability-revolt',
        'ms-ability-ring-bearer',
        'ms-ability-riot',
        'ms-ability-robber-of-the-rich',
        'ms-ability-role-cursed',
        'ms-ability-role-monster',
        'ms-ability-role-royal',
        'ms-ability-role-sorceror',
        'ms-ability-role-wicked',
        'ms-ability-role-young-hero',
        'ms-ability-saddle',
        'ms-ability-specialize',
        'ms-ability-spectacle',
        'ms-ability-spree',
        'ms-ability-static',
        'ms-ability-summoning-sickness',
        'ms-ability-survival',
        'ms-ability-surveil',
        'ms-ability-surveil-original',
        'ms-ability-suspect',
        'ms-ability-the-ring-tempts-you',
        'ms-ability-toxic',
        'ms-ability-training',
        'ms-ability-trample',
        'ms-ability-transform',
        'ms-ability-triggered',
        'ms-ability-unearth',
        'ms-ability-undergrowth',
        'ms-ability-valiant',
        'ms-ability-vigilance',
        'ms-ability-ward',
      ]
    },
    'Mana - DotP Abilities': {
      ...
      icons: [
        ...
        'ms-ability-duels-unblockable',
        'ms-ability-duels-cannot-block',
        'ms-ability-duels-cannot-untap',
        'ms-ability-duels-cohort',
        'ms-ability-duels-copy',
        'ms-ability-duels-deathtouch',
        'ms-ability-duels-defender',
        'ms-ability-duels-delirium',
        'ms-ability-duels-detain',
        'ms-ability-duels-double-strike',
        'ms-ability-duels-dfc',
        'ms-ability-duels-evolve',
        'ms-ability-duels-exalted',
        'ms-ability-duels-exile',
        'ms-ability-duels-fading',
        'ms-ability-duels-fear',
        'ms-ability-duels-first-strike',
        'ms-ability-duels-flying',
        'ms-ability-duels-forestwalk',
        'ms-ability-duels-haste',
        'ms-ability-duels-haunt',
        'ms-ability-duels-hexproof',
        'ms-ability-duels-indestructible',
        'ms-ability-duels-infect',
        'ms-ability-duels-ingest',
        'ms-ability-duels-intimidate',
        'ms-ability-duels-islandwalk',
        'ms-ability-duels-legendary',
        'ms-ability-duels-lifelink',
        'ms-ability-duels-menace',
        'ms-ability-duels-monstrous',
        'ms-ability-duels-mountainwalk',
        'ms-ability-duels-must-attack',
        'ms-ability-duels-plainswalk',
        'ms-ability-duels-prevent-damage',
        'ms-ability-duels-protection-black',
        'ms-ability-duels-protection-blue',
        'ms-ability-duels-protection-green',
        'ms-ability-duels-protection-red',
        'ms-ability-duels-protection-white',
        'ms-ability-duels-protection',
        'ms-ability-duels-rally',
        'ms-ability-duels-regenerate',
        'ms-ability-duels-renowned',
        'ms-ability-duels-shroud',
        'ms-ability-duels-skulk',
        'ms-ability-duels-soulshift',
        'ms-ability-duels-swampwalk',
        'ms-ability-duels-temporary-control',
        'ms-ability-duels-totem-armor',
        'ms-ability-duels-trample',
        'ms-ability-duels-undying',
        'ms-ability-duels-vigilance',
      ]
    },
    'Mana - Counters': {
      prefix: 'ms-',
      icons: [
        'ms-counter-arrow',
        'ms-counter-brick',
        'ms-counter-brick-print',
        'ms-counter-charge',
        'ms-counter-charge-print',
        'ms-counter-damage',
        'ms-counter-deathtouch',
        'ms-counter-devotion',
        'ms-counter-doom',
        'ms-counter-echo',
        'ms-counter-finality',
        ...
        'ms-counter-mining',
        'ms-counter-minus',
        'ms-counter-minus-uneven',
        'ms-counter-muster',
        'ms-counter-paw',
        'ms-counter-pin',
        'ms-counter-plus',
        'ms-counter-plus-uneven',
        'ms-counter-rad',
        'ms-counter-scream',
        'ms-counter-shield',
        'ms-counter-skeleton',
      ...
      prefix: 'ms-',
      icons: [
        'ms-watermark-agentsofsneak',
        'ms-watermark-arena',
        'ms-watermark-colorpie',
        'ms-watermark-conspiracy',
        'ms-watermark-corocoro',
        'ms-watermark-crossbreedlabs',
        'ms-watermark-cutiemark-apples',
        'ms-watermark-cutiemark-balloons',
        'ms-watermark-cutiemark-butterflies',
        'ms-watermark-cutiemark-gems',
        'ms-watermark-cutiemark-rainbow',
        'ms-watermark-cutiemark-sparkle',
        'ms-watermark-cutiemark-waningmoon',
        'ms-watermark-cutiemark-waxingmoon',
        'ms-watermark-dci',
        'ms-watermark-dengekimaoh',
        'ms-watermark-desparked',
        'ms-watermark-dnd',
        'ms-watermark-flavor-aestheticconsultation',
        'ms-watermark-flavor-farewelltoarms',
        'ms-watermark-flavor-manascrew',
        'ms-watermark-flavor-monkeymonkeymonkey',
        'ms-watermark-flavor-moxlotus',
        'ms-watermark-flavor-myfirsttome',
        'ms-watermark-flavor-shoetree',
        'ms-watermark-flavor-whenfluffybunniesattack',
        'ms-watermark-fnm',
        'ms-watermark-goblinexplosioneers',
        'ms-watermark-grandprix',
        'ms-watermark-grandprix2',
        'ms-watermark-japanjunior',
        'ms-watermark-judgeacademy',
        'ms-watermark-junior',
        'ms-watermark-juniorapac',
        'ms-watermark-junioreurope',
        'ms-watermark-leagueofdastardlydoom',
        'ms-watermark-mirran',
        'ms-watermark-mps',
        'ms-watermark-mtg',
        'ms-watermark-mtg10',
        'ms-watermark-mtg15',
        'ms-watermark-nerf',
        'ms-watermark-orderofthewidget',
        'ms-watermark-protour',
        'ms-watermark-scholarship',
        'ms-watermark-transformers',
        'ms-watermark-trumpkatsumai',
        'ms-watermark-wotc',
        'ms-watermark-wpn',
      ]
    },
